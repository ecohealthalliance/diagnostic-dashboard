...
(function(tangelo, $, d3) {
    ...
    tangelo.widget("tangelo.timeline", {
        ...
        _update: function() {
            ...
            this.svg.attr("width", width + 2 * padding + axisPadding).attr("height", height + 2 * padding + axisPadding);
            this.main.attr("transform", "translate(" + (padding + axisPadding) + "," + padding + ")");
