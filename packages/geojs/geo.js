...
geo.osmLayer = function(arg) {
    ...
    this._addTiles = function(request) {
        var feature, ren = m_this.renderer(), zoom = this.map().zoom(), llx = 0, lly = m_this.height(), urx = m_this.width(), ury = 0, temp = null, tile = null, tile1x = null, tile1y = null, tile2x = null, tile2y = null, invJ = null, i = 0, j = 0, worldPt1 = ren.displayToWorld([ llx, lly ]), worldPt2 = ren.displayToWorld([ urx, ury ]);
